    ...
    <el-row :gutter="0">
      <el-col :span="12">
        <div id="show_image">
          ...
          <el-row>
            <el-button type="text" id="change_image">修改头像（200*275）</el-button>
          </el-row>
          <el-row>
      ...
      <el-col :span="12">
        <div id="show_inf">
          ...
          <el-row :gutter="20" class="el-row1">
            ...
            <el-col :span="12">
              <el-input
                  :placeholder="this.store.top_usertype"
          ...
          <el-row :gutter="20" class="el-row1">
            <el-col :span="24">
              <el-button id="btm_confirm">确 认</el-button>
            </el-col>
          </el-row>
        </div>
      </el-col>
